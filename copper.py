...
st.write("""<div style='text-align:center'> <h1 style='color:#009999;'>Industrial Copper Modeling Application</h1> </div>""", unsafe_allow_html=True)


select = option_menu(None, ['HOME','About Project','PRICE PREDICTION','STATUS',],
                        icons=['house','gear','cash-coin','trophy'],orientation='horizontal',default_index=0)
...
if select == 'About Project':
    st.write('### In this project, we have successfully developed a pipeline to preprocess industrial copper data, handle missing values, detect outliers, and address skewness. The Streamlit application provides a user-friendly interface to utilize the trained model for making predictions.')
    st.write('### We have also built regression and classification models to predict the selling price and determine if a sale was won or lost.')
    st.write('### The trained models have been saved as a pickle file for easy retrieval.')
    st.write('### The Streamlit application provides a user-friendly interface to utilize the trained model for making predictions.')
